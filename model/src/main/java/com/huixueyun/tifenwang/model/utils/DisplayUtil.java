...
public class DisplayUtil {
     ...
     * @param animTime      动画时间
     */
    public static void animHideShowView(final View v, AnimationListener al, int measureHeight, final boolean show,
                                        int animTime) {
        if (measureHeight <= 0) {
     ...
     * @param delayMs 延迟时间(毫秒)
     */
    public static void showSoftInputDelayForce(final View view, final long delayMs) {
